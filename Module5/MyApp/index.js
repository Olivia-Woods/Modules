...
app.get(`/`, (req, res) => { // Setting up an endpoint. 'GET' is the HTTP method, used to request data from this route.
    res.send('Hello World'); // Sending a response of 'Hello World' to the client when they access the root URL ('/').
});

app.listen(port, () => { // Starting the server to listen on the specified port.
