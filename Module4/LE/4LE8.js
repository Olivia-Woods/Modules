...
const birthDate = moment("1990-01-01"); // Example: '1990-05-15'
const currentDate = moment();
const daysBetween = currentDate.diff(birthDate, "days");
console.log(`Days between birthdate and today: ${daysBetween}`);
...
const date2 = moment("2024-01-01"); // Example: '2010-05-15'
